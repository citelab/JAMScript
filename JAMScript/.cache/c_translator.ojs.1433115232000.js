...
/*
    ...
    VarBinding      :n = walk:d walk*:i                                                 -> {console.log("i = ", i); i !== undefined ? join(d, ' = ', i.join(',')) : d}
*/
"VarBinding":function(){var n,d,i;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){d=this._apply("walk");i=this._many((function(){return this._apply("walk")}));return (function (){console.log("i = ",i);return ((i !== undefined)?join(d," = ",i.join(",")):d)}).call(this)}).call(this)}).call(this)}))},
