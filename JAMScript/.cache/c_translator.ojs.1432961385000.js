...
/*
    ...
    Declarator      :n = ?n.is('type', 'member') walk:e                                 -> {e !== undefined ? join(this.print_ptr(n), n.name(), '[', e, ']') : join(n.name(), '[]')}
                       | ?n.is('type', 'call') walk:e                                   -> {e !== undefined ? join(this.print_ptr(n), n.name(), '(', e, ')') : join(n.name(), '()')}
                       | ?n.is('type', 'func')                                          -> join('(', this.print_ptr(n), n.name(), ')')
                       | empty                                                          -> join(this.print_ptr(n), n.name())
*/
"Declarator":function(){var n,e;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return this._or((function(){return (function(){this._pred(n.is("type","member"));e=this._apply("walk");return ((e !== undefined)?join(this.print_ptr(n),n.name(),"[",e,"]"):join(n.name(),"[]"))}).call(this)}),(function(){return (function(){this._pred(n.is("type","call"));e=this._apply("walk");return ((e !== undefined)?join(this.print_ptr(n),n.name(),"(",e,")"):join(n.name(),"()"))}).call(this)}),(function(){return (function(){this._pred(n.is("type","func"));return join("(",this.print_ptr(n),n.name(),")")}).call(this)}),(function(){return (function(){this._apply("empty");return join(this.print_ptr(n),n.name())}).call(this)}))}).call(this)}))},
...
*/
"CompoundStmt":function(){var n,d,s;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){d=this._many((function(){return this._apply("walk")}));s=this._apply("walk");return join("{\n",this.indent(this.join_sc(d)),this.indent(this.join_sc(s)),"}\n")}).call(this)}).call(this)}))},
