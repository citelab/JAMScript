...
/*
    ...
    Declarator      :n = ?n.is('type', 'member') walk:e                                 -> {n.length > 2 ? join(this.print_ptr(n), n.name(), '[', e, ']') : join(n.name(), '[]')}
                       | ?n.is('type', 'call') walk+:e                                  -> {console.log("n.length = ", n.length); e !== undefined ? join(this.print_ptr(n), n.name(), '(', e.join(', '), ')') : join(n.name(), '()')}
                       | ?n.is('type', 'func')                                          -> join('(', this.print_ptr(n), n.name(), ')')
                       | empty                                                          -> join(this.print_ptr(n), n.name())
*/
"Declarator":function(){var n,e;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return this._or((function(){return (function(){this._pred(n.is("type","member"));e=this._apply("walk");return ((n["length"] > (2))?join(this.print_ptr(n),n.name(),"[",e,"]"):join(n.name(),"[]"))}).call(this)}),(function(){return (function(){this._pred(n.is("type","call"));e=this._many1((function(){return this._apply("walk")}));return (function (){console.log("n.length = ",n["length"]);return ((e !== undefined)?join(this.print_ptr(n),n.name(),"(",e.join(", "),")"):join(n.name(),"()"))}).call(this)}).call(this)}),(function(){return (function(){this._pred(n.is("type","func"));return join("(",this.print_ptr(n),n.name(),")")}).call(this)}),(function(){return (function(){this._apply("empty");return join(this.print_ptr(n),n.name())}).call(this)}))}).call(this)}))},
