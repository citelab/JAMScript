...
/*
    ...
    //VarDeclStmt     :n = walk+:vs                                                       -> join(this.print_sc(n), ';'),
    VarDeclStmt     :n = anything                                                        -> console.log(this.print_sc(n))
*/
"VarDeclStmt":function(){var n;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){this._apply("anything");return console.log(this.print_sc(n))}).call(this)}).call(this)}))},

/*

    VarBinding      :n = walk:d walk*:i                                                 -> {console.log("d = ", d, "i = ", i);}
*/
"VarBinding":function(){var n,d,i;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){d=this._apply("walk");i=this._many((function(){return this._apply("walk")}));return console.log("d = ",d,"i = ",i)}).call(this)}).call(this)}))},

/*  // i != undefined ? join(d, ' = ', i) : d.name()},
...
/*
    ...
    ParamDeclaration  :n = walk:d                                                       -> {console.log("n = ", n); join(this.print_sc(n), ' ', d)}
*/
"ParamDeclaration":function(){var n,d;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){d=this._apply("walk");return (function (){console.log("n = ",n);return join(this.print_sc(n)," ",d)}).call(this)}).call(this)}).call(this)}))},
