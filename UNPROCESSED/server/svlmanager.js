...
module.exports = {
	...
	createservlet: function(appid, cmdobj, callback) {
		...
		var svlet = new this.Servlet({server: this.host, port: 0}, cmdobj);
		var self = this;
	...
	recreateservlet: function(appid, servinfo, cmdobj, callback) {
		...
		svlet = new this.Servlet(servinfo, cmdobj);
