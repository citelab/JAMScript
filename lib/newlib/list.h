 ...
 * identifying bugs.
 */
#define LIST_POISON_PREV ((ListNode*) 0x010)
 ...
 * identifying bugs.
 */
#define LIST_POISON_NEXT ((ListNode*) 0x020)
...
#define IS_LISTNODE_UNLINKED(listNode) (listNode.next == LIST_POISON_NEXT && listNode.prev == LIST_POISON_PREV)
/**
