...
const astMatcher = {
    ...
    MemberExpression_newExp: {type: "NewFuncallExpr", expr: 1, args: 2},
    ...
    CallExpression_callExpExp: {type: "FuncallExpr", name: 0, args: 1},
    CallExpression_memberExpExp: {type: "FuncallExpr", name: 0, args: 1},
    ...
    AssignmentStatement: {name: 0, val: 2},
    ExpressionStatement: {expr: 0},
    IfStatement: {cond: 2, then: 4, else: 6},
    DoWhileStatement: {stmt: 1, cond: 4},
    WhileStatement: {cond: 2, stmt: 4},
    ForStatement: {init: 2, cond: 4, iter: 6, stmt: 8},
    ForDeclStatement: {init: 3, cond: 5, iter: 7, stmt: 9},
    ForInStatement: {elem: 2, iter: 4, stmt: 6},
    ForInDeclStatement: {elem: 3, iter: 5, stmt: 7},
    ContinueStatement: {name: 1},
    BreakStatement: {name: 1},
    ...
    FunctionDeclaration: {name: 1, params: 3, body: 6},
    FunctionExpression: {name: 1, params: 3, body: 6},
    FunctionBody: {directives: 0, content: 1},
    Directive: {string: 0},

    // rules for es6.ohm
    ArrowFunction: {params: 0, body: 2},
    ConciseBody_noBraces: {expr: 0},
    ConciseBody_withBraces: {body: 1},
    ArrowParamsParen: {params: 1},
    AsyncFunctionDeclaration: {name: 1, params: 3, body: 6},
