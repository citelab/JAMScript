...
module.exports = {
        ...
        if (jdata.type === "Jdata_spec_Basic") {
            ...
            for (var entry of jdata.struct_entries) {
                ...
                if (entry.array) {
                    ...
                    size = parseInt(entry.array.value) * (tc === "c" || tc === "b" ?  1 : 9 ) + 8;
            ...
            var bufferLength = parseInt(jdata.array.value) * (tc === "c" || tc === "b" ?  1 : 9 ) + 8;
    ...
    dflowReadWrapper: function(jdata) {
        ...
        if (jdata.type === "Jdata_spec_Basic" || jdata.type === "Jdata_spec_Array") {
            ...
            if (jdata.array)
                tc = tc.toUpperCase();
            func.body.block.push(astify(`dfread_basic_type(${jdata.namespace_name}, '${tc}', (void*)value);`, "Expr_stmt"));
        } else if (jdata.type === "Jdata_spec_Struct") {
