...
cTranslator.Left_expr_Call = function(left, params) {
  ...
  if(res !== undefined && (res == "function" || res == "activity")) {
    // scallGraph.c.get(currentFunction).add(left.cTranslator);
  }
  return left.cTranslator + paramString;
}

jamCTranslator.Call_expr = function(_1, assign_list, _2) {
  console.log(assign_list.asIteration());
  return "";
}
...
es5Translator.CallExpression_memberExpExp = function(exp, args) {
  console.log(exp.es5Translator + args.es5Translator);
