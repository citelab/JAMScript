...
var jCondTranslator = {
    ...
    Jcond_expr_namespace: function(namespace, _, id) {
        return {
            source: `this.jcore.jcond.get('${namespace.sourceString}.${id.sourceString}').source`,
            code: jConditions.get(namespace.sourceString + "." + id.sourceString).code,
            cback: `this.jcore.jcond.get('${namespace.sourceString}.${id.sourceString}').cback`,
            bcasts: `this.jcond.get('${namespace.sourceString}.${id.sourceString}').bcasts`
        }
        return '';
    ...
    Jcond_expr_id: function(id) {
        ...
        return {
            source: `this.jcore.jcond.get('${id.sourceString}').source`,
            code: jConditions.get(id.sourceString).code,
            cback: `this.jcore.jcond.get('${id.sourceString}').cback`,
            bcasts: `this.jcond.get('${id.sourceString}').bcasts`
        };
    },
