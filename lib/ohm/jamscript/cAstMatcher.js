...
const astMatcher = {
    ...
    Param_decl_JamArray: {jamtype: 1, name: 2, size: 3},
    Param_decl_JamList: {jamtype: 1, name: 2},
    Function_def_JamArray: {jamtype: 1, size: 2, name: 3, params: 4, body: 5},
    Function_def_JamList: {jamtype: 1, name: 2, params: 3, body: 4},
