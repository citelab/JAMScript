...
var jamJSTranslator = {  
  ...
  Flow_flow: function(id, _1, _2, _3, func, _4, input) {
    return `var ${id.sourceString} = flowFunc(Flow.from(${input.sourceString}));`;
  },
  Flow_outflow: function(id, _1, _2, _3, input) {
    return `var ${id.sourceString} = new OutFlow('${id.sourceString}', ${input.sourceString}).start();`;
  },
  Flow_inflow: function(id, _1, _2, _3, input) {
    return `var ${id.sourceString} = new InFlow('${input.jamJSTranslator}')`;
  },
  ...
  C_type_struct: function(_1, _2, entries, _3) {
    return entries.jamJSTranslator;
  },
  ...
  Jdata_decl: function(_1, _2, jdata_spec, _3) {
    ...
    // console.log(symbolTable.get('test'));
    return '';
  },
...
es5Translator.AssignmentStatement = function(left, _2, right) {
