...
var jamJSTranslator = {
    ...
    `;
		...
		const mbox = task.generateMbox(symbolTable.task.js, false);
		const jstartMbox = task.generateMbox(symbolTable.task.js, true);
	...
	Sync_task: function (_1, jCond_spec, _2, functionDeclaration) {
		...
		tableManager.setTaskName(specs.fname);
