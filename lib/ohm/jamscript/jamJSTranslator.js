...
var jamJSTranslator = {
  Program: function (directives, elements) {
    ...
    async function main_program() {
      ...
      console.log("After worklib init...");
      await user_program();
    }
    ...
    const jsOut =
      ...
      '//redserv = await __datalib.createRedis(jsys.redis.host, jsys.redis.port); \n' +
      '//await __datalib.configureRedis(redserv, jsys.redis.host, jsys.redis.port, jsys.nodeid); \n' +      
      mbox +
      jcond +
