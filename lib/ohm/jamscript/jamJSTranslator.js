...
var jamJSTranslator = {
  Program: function (directives, elements) {
    ...
    let jdata_creatR = hasJdata ? 'await __datalib.configureRedis(redserv, jsys.redis.host, jsys.redis.port, jsys.nodeid, ()=> { __worklib.notifyRedis(jsys.redis.host, jsys.redis.port); }); \n' : ''
