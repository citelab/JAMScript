...
var jamJSTranslator = {
  Program: function (directives, elements) {
    ...
    fs.writeFileSync("/Users/olinayu/Desktop/test.js", jsout);
  ...
  Jtask_activity: function(_, _, jConditionSpecifier, jAttributeSpecifier, functionName, _, params, _, _, statements, _) {
    return `function ${functionName.jamJSTranslator.name}(${params.jamJSTranslator}){${statements.jamJSTranslator}}\n`;
  },
...
function getFunctionNames(node) {
  var code = node.sourceString;
