...
var jamJSTranslator = {
    ...
    Jview_decl: function(_1, _2, specs, _3) {
        ...
        return {
            js: "var socket = io('http://localhost:3000');\n" + jsout,
            jview: output
        };
    },
    ...
    Jview_page: function(id, _1, _2, _3, elems, _4) {
        ...
        // output.panels = elems.jamJSTranslator.jview;
        // console.log(elems.jamJSTranslator);
        var outputPanels = [];
        var jsout = "";
    ...
    Display_elem: function(id, _1, _2, _3, specs, _4) {
        ...
        return {
            js: `setInterval(() => {socket.emit('${id.sourceString}', {x: Date.now(), y: ${jdataSource}.lastValue(), gateIndex: 0, id: "${jdataSource}"});}, ${refreshRate});\n`,
            jview: output
        };
    },
    ...
    Jcond_entry: function(id, _1, rules, _2) {
        ...
        for (var i = 0; i < rest.numChildren; i++) {
            ...
            cback.push(rest.child(i).jamJSTranslator.cback);
            bcasts = mergeElements(bcasts, rest.child(i).jamJSTranslator.bcasts);
        }
        return {
            name: id.sourceString,
            string: string,
