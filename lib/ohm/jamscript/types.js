...
module.exports = {
    ...
    castLocalArgs: function(args, types) { // For local calls, we need to cast to the correct array type
    ...
    castRemoteArgs: function(args, types) { // Remote calls just cast to an nvoid because we immediately encode it
        if (args.length != types.length)
