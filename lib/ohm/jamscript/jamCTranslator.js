...
var jamCTranslator = {
    ...
    Sync_ctx_activity: function(_, specs, jCond_spec, declarator, namespace, stmt) {
        var c_codes = [];
        var jCond = {
            source: "true",
            code: 0,
        ...
        var js_output = activities.CreateCSyncCtxJSFunction(funcname, jCond, params);
        var c_output = activities.CreateCSyncCFunction(rtype, funcname, params, stmt.cTranslator);
