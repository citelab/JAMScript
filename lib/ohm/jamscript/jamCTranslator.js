...
cTranslator.Assign_stmt_Struct = function(id, _1, _2, members, _3, _4) {
    var symbol = symbolTable.get(id.sourceString);
    // if (cTranslatorFile.getCurrentTable().isVarGlobal(id.sourceString)) {
    //     cTranslatorFile.update
    // }
    if (symbol !== undefined && symbol.type === "jdata") {
...
cTranslator.Function_def = function(specs, decl, stmts) {
    ...
    // let table1 = new VarTable(cTranslatorFile.getCurrentTable());
    // cTranslatorFile.updateCurrentTable(table1);
    tableManager.enterScope();

    // let table2 = new VarTable(cTranslatorFile.getCurrentTable());
    // cTranslatorFile.updateCurrentTable(table2);
    tableManager.enterScope();
    ...
    // cTranslatorFile.updateCurrentTable(table2.parent);
    // cTranslatorFile.updateCurrentTable(table1.parent);
...
module.exports = {
    compile: function(input, offset, manager) {
