    ...
    Jcond_decl: function(node) {
        ...
        for (var decl of node.decls) {
            ...
            if (node.type === "jcond") {
                ...
                nds.push(astify(`int __jreuse__${namespace.currentNamespace}__${decl.name.name}(${decl.reuse_spec} ${decl.first.name}, ${decl.reuse_spec} ${decl.second.name}) {}`, "Function_def"));
            }
