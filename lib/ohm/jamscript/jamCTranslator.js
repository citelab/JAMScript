...
var jamCTranslator = {
	...
	Source: function (node) { // TODO we need a preprocess pass for this of course
	...
	Prototype: function (node) {
		...
		if (taskInfo && taskInfo.language === 'js') {
			let jsTaskWrapper = activities.createJsTaskWrapperInC(rtype, idTranslated, parameters);
		}
