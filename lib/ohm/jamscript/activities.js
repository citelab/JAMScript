...
module.exports = {
  CreateCASyncJSFunction: function (fname, jCond, params) {
    ...
    funccode += `jnode.remoteAsyncExec("${fname}", [ ${ps.join(',')} ], "${jCond.source}", ${jCond.code}, "${jCond.cback}");\n`;
  ...
  CreateCSyncJSFunction: function (fname, jCond, params) {
    ...
    // write the code that would call the remote function
    funccode += `return jnode.remoteSyncExec("${fname}", [ ${ps.join(',')} ], "${jCond.source}", ${jCond.code}, "${jCond.cback}");\n`;
  ...
  CreateJSAsyncMachFunction: function (fname, jCond, params) {
    ...
    jsout += `jnode.machAsyncExec("${fname}", [ ${params.join(',')} ], "${jCond.source}", ${jCond.code}, "${jCond.cback}");\n`;
    jsout += "}\n";
  ...
  CreateJSSyncMachFunction: function (fname, jCond, params) {
    var jsout = "function " + fname + "(" + params.join(',') + ") {\n";
    jsout += `return jnode.machSyncExec("${fname}", [ ${params.join(',')} ], "${jCond.source}", ${jCond.code}, "${jCond.cback}");\n`;
    jsout += "}\n";
