...
var es5Translator = {
  ...
  IterationStatement_for3var: function(_1, _2, _3, vars, _4, exp1, _5, exp2, _6, stmt) {
    return "for (var " + vars.es5Translator + "; " + exp1.es5Translator + "; " + exp2.es5Translator + ") " +  insertYieldPoint(stmt);
  },
  ...
  IterationStatement_forInVar: function(_1, _2, _3, vars, _4, exp, _6, stmt) {
    return "for (var " + vars.es5Translator + " in " + exp.es5Translator + ") " +  insertYieldPoint(stmt);
  },
