...
var es5Translator = {
  ...
  //   return "delete " + exp.es5Translator;
  // },
  // UnaryExpression_voidExp: function(_, exp) {
  //   return "void " + exp.es5Translator;
  // },
  // UnaryExpression_typeofExp: function(_, exp) {
  //   return "typeof " + exp.es5Translator;
  // },
  ...
  //     code += stmts.child(i).es5Translator;
  //   }
  //   return code;
  // },
  AssignmentStatement: function(namespace, _1, left, _2, right) {
    if(namespace.numChildren > 0) {
      return namespace.es5Translator + '.' + left.es5Translator + ' = ' + right.es5Translator + ';';
    } else {
  ...
  //   return id.sourceString + init.es5Translator;
  // },
  ...
  IterationStatement_doWhile: function(_1, stmt, _2, _3, exp, _4, _5) {
    return "do " + assureBlock(stmt) + " while (" + exp.es5Translator + ");"
  },
  IterationStatement_whileDo: function(_1, _2, exp, _3, stmt) {
    return "while (" + exp.es5Translator + ") " + assureBlock(stmt);
  },
  IterationStatement_for3: function(_1, _2, exp1, _3, exp2, _4, exp3, _5, stmt) {
    return "for (" + exp1.es5Translator + "; " + exp2.es5Translator + "; " + exp3.es5Translator + ") " +  assureBlock(stmt);
  },
  ...
  //     code += nodes.child(i).es5Translator;
