...
/*
exec("hostname -I", function(e, stdout, stderr){
    var arr = stdout.split(" ");
    if(arr.length==3) host = arr[1];
    else host = arr[0];
...
class JAMDatasource {
    ...
    constructor(jammanager, type, name, source, destination) {
        ...
        // the type of data that can be logged into datastreams in this datasource (number, string or JSON object)
