...
module.exports = new function() {
	...
	this.remoteSyncExec = async (function (name, params, expr, vec, rtype) {

        try {
            // TODO: We need to put the new time-based synchronization scheme here..
            await(remoteSyncExecute(name, params, expr, vec, rtype));
        } catch (e) {
            console.log(e);
        }
    });
...
function remoteSyncExecute(name, params, expr, vec, rtype) {

    return new Promise(function(resolve, reject) {
        
        if (machtype == 'DEVICE') {
            // send out the execute to the C side..
            var tmsg = {"cmd": "REXEC-SYN", "opt": "SYN", "cond": expr, "condvec": vec, "actname": name, "actid": "-", "actarg": rtype, "args": params};
            console.log(tmsg);
