...
module.exports = new function() {
	...
	// this.remoteSyncExec = async (function (name, params, expr, vec) {

    //     try {
    //         // TODO: We need to put the new time-based synchronization scheme here..
    //         await(remoteSyncExecute(name, params, expr, vec));
    //     } catch (e) {
    //         console.log(e);
    //     }
    // });

    this.remoteSyncExec = remoteSyncExecute;
    
    this.xxxSyncExec = function (name) {
    ...
    this.machSyncExec = async (function machSyncExec(name, params, expr, vec) {
        
        try {
            // TODO: We need to put the new time-based synchronization scheme here..
            await(machSyncExecute(name, params, expr, vec));
        } catch (e) {
            console.log(e);
        }
...
function xxxSyncExecute(name) {
    
    return new Promise(function(resolve, reject) {
        
        console.log("dfsdfsdfdsfsdfdsf");

    });
}


function remoteSyncExecute(name, params, expr, vec) {

    console.log("Returning a promise...");

    return new Promise(function(resolve, reject) {
        
        console.log("FDFDFDDFDF");
...
// FIXME: The return results should be fixed here.
//
function machSyncExecute(name, params, expr, vec) {
    ...
    return new Promise(function(resolve, reject) {
        ...
        if (machtype === 'DEVICE') {
            ...
            if (fentry === undefined) {
                reject("Function: " + name + "not found");
            }
            ...
            if (eval(expr)) {
                ...
                try {
                    ...
                    resolve("Execution: " + name + " complete");
                } catch(e) {
                    reject("Error running: " + name);
                }
            }
            else 
                reject("Error executing expr: " + expr);
        }
        else 
        {
