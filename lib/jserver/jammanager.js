...
var host = sync_exec("ifconfig eth0 2>/dev/null|awk '/inet addr:/ {print $2}'|sed 's/addr://'").stdout;
if(host==null || host==undefined) 
    host = sync_exec("ifconfig eno1 2>/dev/null|awk '/inet addr:/ {print $2}'|sed 's/addr://'").stdout;
