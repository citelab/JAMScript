...
Registrar.prototype.connectToNewLocalRegistry = function (
  ...
  this.localRegistriesMap.set(localRegistryId, {
    ...
    port: this.localRegistriesMap.get(localRegistryId)["port"],
    ip: this.localRegistriesMap.get(localRegistryId)["ip"],
    loc: this.localRegistriesMap.get(localRegistryId)["loc"],
