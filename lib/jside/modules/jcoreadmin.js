    ...
    async adminProcessor(msg, callback) {
        switch (msg['cmd']) {
            ...
            case constants.CmdNames.REGISTER:
                return await this.__registerNode(msg);
            case constants.CmdNames.REF_CLOUD_FOG_INFO:
                return await this.__refreshCloudFogInfo(msg);
            case constants.CmdNames.GET_CLOUD_FOG_INFO:
                return await this.__getCloudFogInfo(msg, callback);
            case constants.CmdNames.PONG:
                return await this.__processPong(msg);
            default:
