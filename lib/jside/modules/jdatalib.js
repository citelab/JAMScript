...
async function configureRedis(main, host, port, uid, cb) {
...
class UFlow {
    ...
    async write(value) {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.rs.call('fcall', 'uf_write', 1, this.key, clock, 1, this.id, jsys.long, jsys.lat, val, function(err, resp) {
                if (err === null)
                    resolve(resp);
                else 
                    resolve(null);
