    ...
    async replyProcessor(msg) {
        ...
        switch (msg['cmd']) {
            ...
            case CmdNames.MEXEC_ACK:
                this.jcore.otasktbl.processAck(msg.taskid, msg.args[0]);
            break;
            case CmdNames.REXEC_ERR:
            case CmdNames.MEXEC_ERR:
                this.jcore.otasktbl.processErr(msg.taskid, msg.args[0]);
                break;
            case CmdNames.REXEC_NAK:
            case CmdNames.MEXEC_NAK:
                this.jcore.otasktbl.processNak(msg.taskid, msg.args[0]);
                break;
            case CmdNames.REXEC_RES:
            case CmdNames.MEXEC_RES:
                this.jcore.otasktbl.processRes(msg.taskid, msg.args[0]);
            break;
        }
    }
