            ...
            case CmdNames.REXEC:
                ...
                if (res !== undefined) {
                    ...
                    if (res.state === INQ_States.COMPLETED)
                        return JAMP.createRemotePutRes(msg.nodeid, msg.taskid, this.jcore.jamsys.id, msg.fn_argsig, res.results);
                    else
                    ...
                    if (pres && Math.random() < pres.prob)
                        return JAMP.createRemotePutRes(msg.nodeid, msg.taskid, this.jcore.jamsys.id, msg.fn_argsig, pres.results)
            ...
            case CmdNames.GET_REXEC_RES:
                ...
                if (res !== undefined) {
                    ...
                    if (res.state === INQ_States.COMPLETED)
                        ...
                        return JAMP.createRemotePutRes(msg.nodeid, msg.taskid, this.jcore.jamsys.id, msg.fn_argsig, cres);
                    }
                } else 
