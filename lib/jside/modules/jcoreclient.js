...
class JCoreClient {
     ...
     */    
    remoteTaskExec(name, params, nodeid, taskid, rrequired) {
        let that = this;
        let req = JAMP.createRemoteTaskReq(name, params, nodeid, taskid, results);
        ...
        this.jcore.otasktbl.insert(nodeid + taskid, function cb(code, val) {
            ...
            else if (state === StateNames.ACK_RECVD && results) {
