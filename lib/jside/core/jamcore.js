...
class JAMCore {
    ...
    addWorker(worker) {
        this.worker = worker;
        let that = this;
        this.worker.postMessage([{cmd: CmdNames.SET_JSYS, data: {nodeid: this.jamsys.id, type: this.jamsys.machtype, tags: this.jamsys.tags, long: this.jamsys.long, lat: this.jamsys.lat}}]);
