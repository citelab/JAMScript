...
class JAMProtocol {
    ...
    static createRemotePutRes(taskid, nodeid, oldid, fmt, res) {
        return {cmd: CmdNames.REXEC_RES, taskid: taskid, nodeid: nodeid, oldid: oldid, fn_argsig: fmt, args: [res]};
    }
    ...
    static createMachPutRes(taskid, nodeid, oldid, res) {
        return {cmd: CmdNames.MEXEC_RES,
                nodeid: nodeid,
                taskid: taskid,
                oldid: oldid,
                args: [res]};
    ...
    static createMachPutNak(taskid, nodeid, oldid) {
        return {cmd: CmdNames.MEXEC_NAK,
            nodeid: nodeid,
            taskid: taskid,
            oldid: oldid};
    }
