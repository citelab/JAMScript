    ...
    render(){
        ...
        const ControllerItem = function(item,idx) {
            ...
            switch (item.type){
                ...
                case 'terminal':
                    return (
                        <TerminalController { ...item } trigger={props.addCommand} displayLabel={displayLabel} key={idx}/>
                    )
                    break
                case 'multiStateButton':
                    return (
                        <MultiStateButton { ...item } changeValue={props.changeValue} trigger={trigger} displayLabel={displayLabel} key={idx}/>
                    )
            }
        }
