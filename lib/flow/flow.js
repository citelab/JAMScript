...
module.exports = function(Manager){
    ...
    class IteratorFlow extends Flow{
        ...
        constructor(iterator){
            ...
            this.shouldCache = true;    //If the Flows shou;d save processed data
        }
    ...
    class InFlow extends Flow{
        ...
        notify(keyObject){
            ...
            this.manager.redis.rawCall(['ZRANGE', key, this.lastValueIndex + 1, -1], function(e, response){
                if( e )
                    throw new Error(e);
                ...
                for (var i = 0; i < response.length; i++) {
                    ...
                    parts = response[i].split(this.manager.delimiter);
                    //pack = {
                    //    key: keyObject,
                    //    data: parts[0],
                    //    timestamp: parts[3]
    ...
    class ParallelFlowProcessor{
        constructor(pFlow, callback){
            ...
            //examine the call tree and break the job into tasks
        }
