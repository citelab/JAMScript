...
module.exports = new function() {
    ...
    this.init = function (reg, mtype) {
        ...
        this.ncache = getNcache(sys.link);
    }
...
function getNcache(linkp) {
    if (this.ncache === undefined) {
        this.ncache = new NodeCache(200, 2, 2000, linkp);
    }
    return this.ncache;
}
...
function doRegister() {
    ...
    this.ncache.onCloudUp(function(id, info) {
        ...
        if (cserv === undefined && id !== undefined && info !== undefined) {
            ...
            sys.setCloud(cid);
            this.ncache.setCurrentCloud(cid);
        }
    });
    ...
    if (machtype === globals.NodeType.FOG) {
        ...
        reggie.on('cloud-datadepot-up', function(id, info) {
            this.ncache.cloudDataUp(id, info);
        });
