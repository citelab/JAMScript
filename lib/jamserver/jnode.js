...
function machAsyncExec(name, params, oexpr, vec, bcasters, cb) {
    ...
    pushLevel(mlevel);
    try {
        console.log("OExpr ", oexpr);
        var o2 = eval(oexpr);
        console.log("O2 ", o2);
        var o3 = eval(o2);
        console.log("O3 ", o3);

        var eres = oexpr.length === 0 || o3;
    } catch (e) {
        console.log("Error.. ", e);
    }

    console.log("Eres ", eres, " mlevel ", mlevel);
    ...
    else
    {
        ...
        console.log("Deferring the execution.....", bclock, "actname ", name);
        // Create the execution call.. message
...
function validClock(aarg) {
    ...
    console.log("Received clock ", rclock, " multicast clock ", mclock);
