...
function doRemoteAsyncExec(name, params, expr, vec, cbmode, bcasters, cback, callback) {
...
function machSyncExec(name, params, oexpr, vec, bcasters, cback, callback) {
...
//
function machAsyncExec(name, params, oexpr, vec, bcasters, cback) {
