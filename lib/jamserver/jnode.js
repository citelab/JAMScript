...
function remoteAsyncExec(name, params, expr, vec, callback) {
    doRemoteAsyncExec(name, params, expr, vec, false, callback);
}


function remoteAsyncExecCB(name, params, expr, vec, callback) {
    doRemoteAsyncExec(name, params, expr, vec, true, callback);
}


function doRemoteAsyncExec(name, params, expr, vec, cbmode, callback) {
...
function machSyncExec(name, params, oexpr, vec, callback) {
