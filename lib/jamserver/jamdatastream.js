    ...
    process_zrange_response(e, response, datastream) {
        ...
        if (e) {
            ...
            for (var i = 0; i < response.length; i++) {
                ...
                if( datastream.jammanager.getParentRedis() != null ) {//if the redis connection to parent is not null
                    console.log("Parent redis is NOT null...", dest);
                ...
                if( forward ) {
                    ...
                    datastream.jammanager.simpleLog(datastream.key, response[i], null, datastream.jammanager.getParentRedis(), (parts.length > 3 ? parts[4] : parts[3]) - 0);
                }
            }
