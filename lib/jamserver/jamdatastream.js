    ...
    process_zrange_response(e, response, datastream) {
        ...
        if (e) {
            ...
            for (var i = 0; i < response.length; i++) {
                var log = cbor.decodeFirstSync(response[i]).value;
                ...
                if( forward ) {
                    ...
                    datastream.jammanager.simpleLog(datastream.key, reponse[i], null, datastream.jammanager.getParentRedisLogger(), timestamp);
                }
            }
