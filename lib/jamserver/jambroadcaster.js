...
class JAMBroadcaster{
    constructor(channel, jammanager){
        ...
        //let all instances of the broadcaster share same counter
        if( !JAMBroadcaster.counter )
            JAMBroadcaster.counter = 1;
    }
    ...
    broadcast(message, fromSelf){
        ...
        else{}  //TODO when data mod hooks are added, implement counter bumping
        ...
        if( (typeof message == "object" || (typeof message == "string" && message.indexOf(0) == "{")) ){
            if( typeof message == "object" )
                ...
                this.lastValue = JSON.parse(message);
        ...
        else    //the value may either be a string or number
            this.lastValue = message;
