...
module.exports = (function(host, port) {
    ...
    pack = {
        ...
        deviceID: new Date().getTime() + "" //TODO change implementation to return correct value
    };
