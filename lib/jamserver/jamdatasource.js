...
<<<<<<< HEAD
        this.key = 'apps[' + this.app + '].namespaces[' + this.namespace + '].datasources[' + this.name + ']';
=======
...
=======
    ...
    findAllStreams(){
        ...
        var self = this;
        redis.rawCall(['KEYS', pattern], function(err, response){
            if( err )
                console.log(err);
...
<<<<<<< HEAD
    buildKey(dev_id) {
        var key = 'apps[' + this.app + '].' +
            'namespaces[' + this.namespace + '].' +
            'datasources[' + this.name + '].' +
            'datastreams[' + dev_id + ']';
        return key;
    }
