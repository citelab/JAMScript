...
class JCoreAdmin {
    ...
    //        console.log('------------FogUp------->>>>-------------------------');
     ...
     //           console.log('--------------- |||Setting the fog...---------------');
                ...
                that.jcore.runnerSockConfig(that.jcore.fserv, '/' + cmdopts.app + '/mach/func/request', `/${cmdopts.app}/${jsys.zone}/zoneconf`);
       ...
       //         console.log("!!!!!!! cloud up.....");
                ...
                if (that.machtype === globals.NodeType.FOG)
                    that.jcore.runnerSockConfig(that.jcore.cserv, '/' + cmdopts.app + '/mach/func/request', `/${cmdopts.app}/${jsys.zone}/zoneconf`);
        ...
        if (this.machtype === globals.NodeType.DEVICE) {
            ...
            if (contextManager) {
                this.reggie.on('fog-up', (id, info) => contextManager.fogUp(id, info));
                this.reggie.on('fog-down', id => contextManager.fogDown(id));
            }
