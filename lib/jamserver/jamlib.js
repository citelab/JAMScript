...
var reggie = new Registrar(cmdopts.app, machType, deviceParams.getItem('deviceId'),
						...
						{ protocols: { mqtt: false, mdns: true, localStorage: false } });
...
var learner = new Worker('./jlearn.js');
jcore.setLearner(learner);
learner.postMessage({cmd: 'CONF-DATA', opt:'CMDOPTS', data: cmdopts});
learner.postMessage({cmd: 'CONF-DATA', opt:'JSYS', data: jamsys});
