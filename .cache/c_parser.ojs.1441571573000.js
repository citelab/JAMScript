...
/*
    typename        = iName:kwd isTypename(kwd)                      -> {console.log("HELLO", kwd); __.TypeSpec().type(kwd); console.log("END");}
*/
"typename":function(){var kwd;return this._or((function(){return (function(){undefined;return (function(){kwd=this._apply("iName");this._applyWithArgs("isTypename",kwd);return (function (){console.log("HELLO",kwd);__.TypeSpec().type(kwd);return console.log("END")}).call(this)}).call(this)}).call(this)}))},
...
*/
"declaration":function(){var ds,idec;return this._or((function(){return (function(){undefined;return this._or((function(){return (function(){ds=this._apply("decl_specs");this._pred((ds[(2)].hasType("StorageClassSpec") && (ds[(2)].class() === "typedef")));idec=this._apply("init_decl_lst");this._applyWithArgs("token",";");return (function (){this["spec"].addTypename(idec[(0)][(2)].name());return __.Declaration(ds,idec)}).call(this)}).call(this)}),(function(){return (function(){ds=this._apply("decl_specs");idec=this._apply("init_decl_lst");this._applyWithArgs("token",";");return __.Declaration(ds,idec)}).call(this)}))}).call(this)}))},
