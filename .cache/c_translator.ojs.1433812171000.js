...
/*
    ...
    UnionSpec       :n = walk*:s                                                        -> {s.length > 0? join('struct ', n.name(), ' {', s.join('\n'), '}') : join('struct ', n.name())}
*/
"UnionSpec":function(){var n,s;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){s=this._many((function(){return this._apply("walk")}));return ((s["length"] > (0))?join("struct ",n.name()," {",s.join("\n"),"}"):join("struct ",n.name()))}).call(this)}).call(this)}))},
...
/*
    ...
    SDeclarator     :n = walkType(#Declarator)?:d walk?:e                                 -> console.log("Hello d ", d, "e ", e)
*/
"SDeclarator":function(){var n,d,e;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){d=this._opt((function(){return this._applyWithArgs("walkType","Declarator")}));e=this._opt((function(){return this._apply("walk")}));return console.log("Hello d ",d,"e ",e)}).call(this)}).call(this)}))},
