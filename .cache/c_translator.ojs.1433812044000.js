...
/*
    ...
    SDeclarator     :n = walkType(#Declarator):d walk?:e                                 -> console.log("Hello")
*/
"SDeclarator":function(){var n,d,e;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){d=this._applyWithArgs("walkType","Declarator");e=this._opt((function(){return this._apply("walk")}));return console.log("Hello")}).call(this)}).call(this)}))},
