...
/*
    ...
    declaration     = decl_specs:ds ?(ds[2].hasType(#StorageClassSpec) && ds[2].class() === #typedef)
                                    init_decl_lst:idec ";"          -> {console.log("=======", idec[0][2]); __.Declaration(ds, idec)}
                    | decl_specs:ds init_decl_lst:idec ";"          -> {console.log(ds); __.Declaration(ds, idec)}
*/
"declaration":function(){var ds,idec;return this._or((function(){return (function(){undefined;return this._or((function(){return (function(){ds=this._apply("decl_specs");this._pred((ds[(2)].hasType("StorageClassSpec") && (ds[(2)].class() === "typedef")));idec=this._apply("init_decl_lst");this._applyWithArgs("token",";");return (function (){console.log("=======",idec[(0)][(2)]);return __.Declaration(ds,idec)}).call(this)}).call(this)}),(function(){return (function(){ds=this._apply("decl_specs");idec=this._apply("init_decl_lst");this._applyWithArgs("token",";");return (function (){console.log(ds);return __.Declaration(ds,idec)}).call(this)}).call(this)}))}).call(this)}))},
