...
/*
    ...
    declaration     = decl_specs:ds ?(ds[2].hasType(#StorageClassSpec))
...
*/
"declaration":function(){var ds,idec;return this._or((function(){return (function(){undefined;return this._or((function(){return (function(){ds=this._apply("decl_specs");this._pred(ds[(2)].hasType("StorageClassSpec"));idec=this._apply("init_decl_lst");this._applyWithArgs("token",";");return (function (){console.log("Matched First Rule");return __.Declaration(ds,idec)}).call(this)}).call(this)}),(function(){return (function(){ds=this._apply("decl_specs");idec=this._apply("init_decl_lst");this._applyWithArgs("token",";");return (function (){console.log(ds);return __.Declaration(ds,idec)}).call(this)}).call(this)}))}).call(this)}))},
