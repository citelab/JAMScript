...
/*
    ...
    EnumDeclaration     :n  = walk*:d                                                   -> join('enum', ' ', n.name(), d.length > 0? join("{", d.join(','), "}") : "")
*/
"EnumDeclaration":function(){var n,d;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){d=this._many((function(){return this._apply("walk")}));return join("enum"," ",n.name(),((d["length"] > (0))?join("{",d.join(","),"}"):""))}).call(this)}).call(this)}))},

/*

    Enumerator      :n = walk:d                                                         -> join(n.name(), d !== undefined? join(" = ", d) : "")
*/
"Enumerator":function(){var n,d;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){d=this._apply("walk");return join(n.name(),((d !== undefined)?join(" = ",d):""))}).call(this)}).call(this)}))},
