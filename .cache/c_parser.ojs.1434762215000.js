...
/*
    ...
    store_cl_spec   = ("extern" | "static" | "auto" | "register"):s   -> __.StorageClassSpec().class(s.value())
*/
"store_cl_spec":function(){var s;return this._or((function(){return (function(){undefined;return (function(){s=this._or((function(){return (function(){return this._applyWithArgs("token","extern")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","static")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","auto")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","register")}).call(this)}));return __.StorageClassSpec().class(s.value())}).call(this)}).call(this)}))},
...
//    topLevel     = union_spec:u spaces end    -> u
