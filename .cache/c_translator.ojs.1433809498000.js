...
*/
"SDeclarator":function(){var n,d,e;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){d=this._applyWithArgs("walkType","Declarator");e=this._opt((function(){return this._apply("walk")}));return (function (){if((d === undefined)){return join(": ",e)}else{if((e === undefined)){return d.name()}else{return join(d.name()," : ",e)}}}).call(this)}).call(this)}).call(this)}))},
