...
*/
"type_spec":function(){return this._or((function(){return (function(){undefined;return this._or((function(){return (function(){return this._applyWithArgs("token","void")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","char")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","short")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","int")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","long")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","float")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","double")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","signed")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","unsigned")}).call(this)}))}).call(this)}))},
