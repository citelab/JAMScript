...
/*
    ...
    Declaration     :n = walk:ds walk+:l                                                 -> {console.log("l = ", l, "length =", l.length);  join(ds, l.join(','), ';')}
*/
"Declaration":function(){var n,ds,l;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){ds=this._apply("walk");l=this._many1((function(){return this._apply("walk")}));return (function (){console.log("l = ",l,"length =",l["length"]);return join(ds,l.join(","),";")}).call(this)}).call(this)}).call(this)}))},
