...
*/
"TypeSpec":function(){var n;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){this._apply("empty");return n.type()}).call(this)}).call(this)}))},
...
*/
"Declaration":function(){var n,ds,l;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){ds=this._apply("walk");l=this._apply("walk");return join(ds,l.join(","),";")}).call(this)}).call(this)}))},

/*

    InitDecl    :n     = walk:d walk:i                                                  -> join(d, ' = ', i)
*/
"InitDecl":function(){var n,d,i;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){d=this._apply("walk");i=this._apply("walk");return join(d," = ",i)}).call(this)}).call(this)}))},
...
*/
"StrucSpec":function(){var n,s;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){s=this._many((function(){return this._apply("walk")}));return ((d["length"] > (0))?join("struct ",n.name()," {",s.join("\n"),"}"):join("struct ",n.name()))}).call(this)}).call(this)}))},

/*

    UnionSpec       :n = walk*:s                                                        -> {d.length > 0? join('struct ', n.name(), ' {', s.join('\n'), '}') : join('struct ', n.name())}
*/
"UnionSpec":function(){var n,s;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){s=this._many((function(){return this._apply("walk")}));return ((d["length"] > (0))?join("struct ",n.name()," {",s.join("\n"),"}"):join("struct ",n.name()))}).call(this)}).call(this)}))},
...
*/
"SDeclarator":function(){var n,d,e;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){d=this._applyWithArgs("walkType","Declarator");e=this._apply("walk");return (function (){if((d === undefined)){return join(": ",e)}else{if((e === undefined)){return d.name()}else{return join(d.name()," : ",e)}}}).call(this)}).call(this)}).call(this)}))},

/*

    ADeclarator     :n = ?n.is('type', 'member') walk:e                                 -> join(this.print_ptr(n), '[', e, ']')
                       | ?n.is('type', 'call') walk+:e                                  -> join(this.print_ptr(n), '(', e.join(', '), ')')
                       | ?n.is('type', 'func') walk:e                                   -> join(this.print_ptr(n), '(', e, ')')
                       | empty                                                          -> {
                                                                                            if (n.is('type', 'member'))
                                                                                                return join(this.print_ptr(n), n.name(), '[]');
                                                                                            else if (n.is('type', 'call'))
...
*/
"ADeclarator":function(){var n,e;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return this._or((function(){return (function(){this._pred(n.is("type","member"));e=this._apply("walk");return join(this.print_ptr(n),"[",e,"]")}).call(this)}),(function(){return (function(){this._pred(n.is("type","call"));e=this._many1((function(){return this._apply("walk")}));return join(this.print_ptr(n),"(",e.join(", "),")")}).call(this)}),(function(){return (function(){this._pred(n.is("type","func"));e=this._apply("walk");return join(this.print_ptr(n),"(",e,")")}).call(this)}),(function(){return (function(){this._apply("empty");return (function (){if(n.is("type","member")){return join(this.print_ptr(n),n.name(),"[]")}else{if(n.is("type","call")){return join(this.print_ptr(n),n.name(),"()")}else{return join(this.print_ptr(n),n.name())}}}).call(this)}).call(this)}))}).call(this)}))},
