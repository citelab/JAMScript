...
/*
    typename        = iName:kwd isTypename(kwd)                      -> {console.log("HELLO", kwd); __.TypeSpec().type(kwd)}
*/
"typename":function(){var kwd;return this._or((function(){return (function(){undefined;return (function(){kwd=this._apply("iName");this._applyWithArgs("isTypename",kwd);return (function (){console.log("HELLO",kwd);return __.TypeSpec().type(kwd)}).call(this)}).call(this)}).call(this)}))},
