...
/*
    ...
    TypeSpec    :n     = walk?:e                                                        -> {if (n.type() === ("enum" || "struct" || "union")) { console.log("REturn E"); return e;} else { console.log("Return n "); return n.type();} }
*/
"TypeSpec":function(){var n,e;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){e=this._opt((function(){return this._apply("walk")}));return (function (){if((n.type() === (("enum" || "struct") || "union"))){console.log("REturn E");return e}else{console.log("Return n ");return n.type()}}).call(this)}).call(this)}).call(this)}))},
