{{var JsonMLWalker=require("../../../deps/jsonml/grammars/jsonml_walker.ojs");var join=require("../../../utils.js")["join"];var join_print=require("../../../utils.js")["join_print"];var getNum=require("../../../utils.js")["getNum"];var escape=require("../../../utils.js")["escape_string"]}var CTranslator=JsonMLWalker.inherit({_grammarName: "CTranslator",
...
*/
"Declaration":function(){var n,ds,l;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){ds=this._apply("walk");l=this._many((function(){return this._apply("walk")}));return join(ds,l.join(","),";")}).call(this)}).call(this)}))},
...
*/
"DoWhileStmt":function(){var n,s,ce;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){s=this._apply("walk");ce=this._apply("walk");return join("do ",ce," while(",s,")",";")}).call(this)}).call(this)}))},
