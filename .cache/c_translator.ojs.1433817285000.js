...
/*
    ...
    StrucDecl       :n = walk:s walk*:l                                                 -> {console.log("l = ", l); join(s, l.join(','), ';')}
*/
"StrucDecl":function(){var n,s,l;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){s=this._apply("walk");l=this._many((function(){return this._apply("walk")}));return (function (){console.log("l = ",l);return join(s,l.join(","),";")}).call(this)}).call(this)}).call(this)}))},
