...
*/
"type_spec":function(){var s,e,t;return this._or((function(){return (function(){undefined;return this._or((function(){return (function(){s=this._or((function(){return (function(){return this._applyWithArgs("token","void")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","char")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","short")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","int")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","long")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","float")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","double")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","signed")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","unsigned")}).call(this)}));return __.TypeSpec().type(s.value())}).call(this)}),(function(){return (function(){e=this._apply("enum_spec");return __.TypeSpec(e).type("enum")}).call(this)}),(function(){return (function(){e=this._apply("struct_spec");return __.TypeSpec(e).type("struct")}).call(this)}),(function(){return (function(){e=this._apply("union_spec");return __.TypeSpec(e).type("union")}).call(this)}),(function(){return (function(){t=this._applyWithArgs("token","Typename");return __.TypeSpec().type(t.value())}).call(this)}))}).call(this)}))},
