...
*/
"SDeclarator":function(){var n,d,e;return this._or((function(){return (function(){(function(){return n=this._apply("anything")}).call(this);return (function(){d=this._applyWithArgs("walkType","Declarator");e=this._opt((function(){return this._apply("walk")}));return console.log("Hello d ",d,"e ",e)}).call(this)}).call(this)}))},
