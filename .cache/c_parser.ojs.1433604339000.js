...
/*
    ...
    struct_spec     = "struct" "Id":s "{" struct_decl+:l "}"
                    | "struct" "Id":s
                    | "struct" "{" struct_decl+:l "}"
*/
"struct_spec":function(){var s,l;return this._or((function(){return (function(){undefined;return this._or((function(){return (function(){this._applyWithArgs("token","struct");s=this._applyWithArgs("token","Id");this._applyWithArgs("token","{");l=this._many1((function(){return this._apply("struct_decl")}));return this._applyWithArgs("token","}")}).call(this)}),(function(){return (function(){this._applyWithArgs("token","struct");return s=this._applyWithArgs("token","Id")}).call(this)}),(function(){return (function(){this._applyWithArgs("token","struct");this._applyWithArgs("token","{");l=this._many1((function(){return this._apply("struct_decl")}));return this._applyWithArgs("token","}")}).call(this)}))}).call(this)}))},

/*


    union_spec      = "union" "Id":s "{" struct_decl+:l "}"
                    | "union" "Id":s
                    | "union" "{" struct_decl+:l "}"
*/
"union_spec":function(){var s,l;return this._or((function(){return (function(){undefined;return this._or((function(){return (function(){this._applyWithArgs("token","union");s=this._applyWithArgs("token","Id");this._applyWithArgs("token","{");l=this._many1((function(){return this._apply("struct_decl")}));return this._applyWithArgs("token","}")}).call(this)}),(function(){return (function(){this._applyWithArgs("token","union");return s=this._applyWithArgs("token","Id")}).call(this)}),(function(){return (function(){this._applyWithArgs("token","union");this._applyWithArgs("token","{");l=this._many1((function(){return this._apply("struct_decl")}));return this._applyWithArgs("token","}")}).call(this)}))}).call(this)}))},

/*

    struct_decl     = spec_qual_list listOf(#sdeclarator, ",") ";"
*/
"struct_decl":function(){return this._or((function(){return (function(){undefined;return (function(){this._apply("spec_qual_list");this._applyWithArgs("listOf","sdeclarator",",");return this._applyWithArgs("token",";")}).call(this)}).call(this)}))},

/*

    spec_qual_list  = (type_spec | type_qualifier)+
*/
"spec_qual_list":function(){return this._or((function(){return (function(){undefined;return (function(){return this._many1((function(){return this._or((function(){return (function(){return this._apply("type_spec")}).call(this)}),(function(){return (function(){return this._apply("type_qualifier")}).call(this)}))}))}).call(this)}).call(this)}))},

/*

    sdeclarator     = declarator ":" const_expr
                    | declarator
                    | ":" const_expr
*/
"sdeclarator":function(){return this._or((function(){return (function(){undefined;return this._or((function(){return (function(){this._apply("declarator");this._applyWithArgs("token",":");return this._apply("const_expr")}).call(this)}),(function(){return (function(){return this._apply("declarator")}).call(this)}),(function(){return (function(){this._applyWithArgs("token",":");return this._apply("const_expr")}).call(this)}))}).call(this)}))},
