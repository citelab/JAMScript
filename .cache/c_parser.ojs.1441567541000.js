{var __=require("../nodes.js");var CParser=OMeta.inherit({_grammarName: "CParser",
...
*/
"isTypename":function(){var x;return this._or((function(){return (function(){(function(){return x=this._apply("anything")}).call(this);return (function(){return this._pred(this["spec"].isTypename(x))}).call(this)}).call(this)}))},
...
*/
"id":function(){var name;return this._or((function(){return (function(){undefined;return (function(){name=this._apply("iName");this._not((function(){return this._applyWithArgs("isKeyword",name)}));this._not((function(){return this._applyWithArgs("isTypename",name)}));return __.Id(name)}).call(this)}).call(this)}))},
...
*/
"typename":function(){var kwd;return this._or((function(){return (function(){undefined;return (function(){kwd=this._apply("iName");this._applyWithArgs("isTypename",kwd);return __.Typename(kwd)}).call(this)}).call(this)}))},
...
*/
"hex":function(){var d;return this._or((function(){return (function(){undefined;return (function(){d=this._consumedBy((function(){return (function(){this._or((function(){return (function(){return this._applyWithArgs("seq","0x")}).call(this)}),(function(){return (function(){return this._applyWithArgs("seq","0X")}).call(this)}));return this._many1((function(){return this._apply("hexDigit")}))}).call(this)}));return __.Number(parseInt(d)).kind("hex")}).call(this)}).call(this)}))},

/*

    octalDigit      = range('0', '7')
*/
"octalDigit":function(){return this._or((function(){return (function(){undefined;return (function(){return this._applyWithArgs("range","0","7")}).call(this)}).call(this)}))},
...
/*
    ...
    octal           = <'0' octalDigit+>:d                           -> __.Number(parseInt(d,8)).kind('oct')
*/
"octal":function(){var d;return this._or((function(){return (function(){undefined;return (function(){d=this._consumedBy((function(){return (function(){this._applyWithArgs("exactly","0");return this._many1((function(){return this._apply("octalDigit")}))}).call(this)}));return __.Number(parseInt(d,(8))).kind("oct")}).call(this)}).call(this)}))},

/*

    decimal         = <'-'? decimalInt ('.' digit+)? expPart?>:f 'f'?    -> __.Number(f).kind('float')
                    | <'-'? ('.' digit+) expPart?>:f 'f'?                -> __.Number(f).kind('float')
*/
"decimal":function(){var f;return this._or((function(){return (function(){undefined;return this._or((function(){return (function(){f=this._consumedBy((function(){return (function(){this._opt((function(){return this._applyWithArgs("exactly","-")}));this._apply("decimalInt");this._opt((function(){return (function(){this._applyWithArgs("exactly",".");return this._many1((function(){return this._apply("digit")}))}).call(this)}));return this._opt((function(){return this._apply("expPart")}))}).call(this)}));this._opt((function(){return this._applyWithArgs("exactly","f")}));return __.Number(f).kind("float")}).call(this)}),(function(){return (function(){f=this._consumedBy((function(){return (function(){this._opt((function(){return this._applyWithArgs("exactly","-")}));(function(){this._applyWithArgs("exactly",".");return this._many1((function(){return this._apply("digit")}))}).call(this);return this._opt((function(){return this._apply("expPart")}))}).call(this)}));this._opt((function(){return this._applyWithArgs("exactly","f")}));return __.Number(f).kind("float")}).call(this)}))}).call(this)}))},
...
/*
    ...
    charLit         = '\'' '\\' <octalDigit octalDigit? octalDigit?>:cs '\''    -> __.Number(cs).kind('char_oct')
                    ...
                    | '\'' <(escapeChar | ~'\'' char)*:cs> '\''                 -> __.Number(cs).kind('char')
*/
"charLit":function(){var cs;return this._or((function(){return (function(){undefined;return this._or((function(){return (function(){this._applyWithArgs("exactly","\'");this._applyWithArgs("exactly","\\");cs=this._consumedBy((function(){return (function(){this._apply("octalDigit");this._opt((function(){return this._apply("octalDigit")}));return this._opt((function(){return this._apply("octalDigit")}))}).call(this)}));this._applyWithArgs("exactly","\'");return __.Number(cs).kind("char_oct")}).call(this)}),(function(){return (function(){this._applyWithArgs("exactly","\'");this._applyWithArgs("exactly","\\");this._applyWithArgs("exactly","x");cs=this._consumedBy((function(){return (function(){return this._many1((function(){return (function(){this._not((function(){return this._applyWithArgs("exactly","\'")}));return this._apply("hexDigit")}).call(this)}))}).call(this)}));this._applyWithArgs("exactly","\'");return __.Number(cs).kind("char_hex")}).call(this)}),(function(){return (function(){this._applyWithArgs("exactly","\'");this._consumedBy((function(){return (function(){return cs=this._many((function(){return this._or((function(){return (function(){return this._apply("escapeChar")}).call(this)}),(function(){return (function(){this._not((function(){return this._applyWithArgs("exactly","\'")}));return this._apply("char")}).call(this)}))}))}).call(this)}));this._applyWithArgs("exactly","\'");return __.Number(cs).kind("char")}).call(this)}))}).call(this)}))},

/*

    number          = charLit | hex | octal | decimal | integer
*/
"number":function(){return this._or((function(){return (function(){undefined;return this._or((function(){return (function(){return this._apply("charLit")}).call(this)}),(function(){return (function(){return this._apply("hex")}).call(this)}),(function(){return (function(){return this._apply("octal")}).call(this)}),(function(){return (function(){return this._apply("decimal")}).call(this)}),(function(){return (function(){return this._apply("integer")}).call(this)}))}).call(this)}))},
...
/*
    ...
    token :tt       = spaces ( ( punctuator | keyword | typename ):t ?(t.value() == tt)      -> t
                    | (id | number | string):t ?(t[0] == tt)                                 -> t
                    )
*/
"token":function(){var tt,t;return this._or((function(){return (function(){(function(){return tt=this._apply("anything")}).call(this);return (function(){this._apply("spaces");return this._or((function(){return (function(){t=this._or((function(){return (function(){return this._apply("punctuator")}).call(this)}),(function(){return (function(){return this._apply("keyword")}).call(this)}),(function(){return (function(){return this._apply("typename")}).call(this)}));this._pred((t.value() == tt));return t}).call(this)}),(function(){return (function(){t=this._or((function(){return (function(){return this._apply("id")}).call(this)}),(function(){return (function(){return this._apply("number")}).call(this)}),(function(){return (function(){return this._apply("string")}).call(this)}));this._pred((t[(0)] == tt));return t}).call(this)}))}).call(this)}).call(this)}))},
...
/*
    ...
    declaration     = decl_specs:ds ?(ds[2].hasType(#StorageClassSpec) && ds[2].value() === #typedef)
                                    init_decl_lst:idec ";"          -> {console.log("Matched First Rule"); __.Declaration(ds, idec)}
                    | decl_specs:ds init_decl_lst:idec ";"          -> {console.log(ds); __.Declaration(ds, idec)}
*/
"declaration":function(){var ds,idec;return this._or((function(){return (function(){undefined;return this._or((function(){return (function(){ds=this._apply("decl_specs");this._pred((ds[(2)].hasType("StorageClassSpec") && (ds[(2)].value() === "typedef")));idec=this._apply("init_decl_lst");this._applyWithArgs("token",";");return (function (){console.log("Matched First Rule");return __.Declaration(ds,idec)}).call(this)}).call(this)}),(function(){return (function(){ds=this._apply("decl_specs");idec=this._apply("init_decl_lst");this._applyWithArgs("token",";");return (function (){console.log(ds);return __.Declaration(ds,idec)}).call(this)}).call(this)}))}).call(this)}))},

/*

    decl_specs      = (store_cl_spec | type_spec | type_qualifier)+:s   -> __.DeclSpec(s)
*/
"decl_specs":function(){var s;return this._or((function(){return (function(){undefined;return (function(){s=this._many1((function(){return this._or((function(){return (function(){return this._apply("store_cl_spec")}).call(this)}),(function(){return (function(){return this._apply("type_spec")}).call(this)}),(function(){return (function(){return this._apply("type_qualifier")}).call(this)}))}));return __.DeclSpec(s)}).call(this)}).call(this)}))},
...
*/
"init_decl":function(){var d,i;return this._or((function(){return (function(){undefined;return this._or((function(){return (function(){d=this._apply("declarator");this._applyWithArgs("token","=");i=this._apply("initializer");return __.InitDecl(d,i)}).call(this)}),(function(){return (function(){d=this._apply("declarator");return __.InitDecl(d)}).call(this)}))}).call(this)}))},
...
*/
"store_cl_spec":function(){var s;return this._or((function(){return (function(){undefined;return (function(){s=this._or((function(){return (function(){return this._applyWithArgs("token","typedef")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","extern")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","static")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","auto")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","register")}).call(this)}));return __.StorageClassSpec().class(s.value())}).call(this)}).call(this)}))},
...
*/
"type_spec":function(){var s,e;return this._or((function(){return (function(){undefined;return this._or((function(){return (function(){s=this._or((function(){return (function(){return this._applyWithArgs("token","void")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","char")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","short")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","int")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","long")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","float")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","double")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","signed")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","unsigned")}).call(this)}));return __.TypeSpec().type(s.value())}).call(this)}),(function(){return (function(){e=this._apply("enum_spec");return __.TypeSpec(e).type("enum")}).call(this)}),(function(){return (function(){e=this._apply("struct_spec");return __.TypeSpec(e).type("struct")}).call(this)}),(function(){return (function(){e=this._apply("union_spec");return __.TypeSpec(e).type("union")}).call(this)}))}).call(this)}))},
...
*/
"struct_spec":function(){var s,l;return this._or((function(){return (function(){undefined;return this._or((function(){return (function(){this._applyWithArgs("token","struct");s=this._applyWithArgs("token","Id");this._applyWithArgs("token","{");l=this._many1((function(){return this._apply("struct_decl")}));this._applyWithArgs("token","}");return __.StrucSpec(l).name(s.value())}).call(this)}),(function(){return (function(){this._applyWithArgs("token","struct");s=this._applyWithArgs("token","Id");return __.StrucSpec().name(s.value())}).call(this)}),(function(){return (function(){this._applyWithArgs("token","struct");this._applyWithArgs("token","{");l=this._many1((function(){return this._apply("struct_decl")}));this._applyWithArgs("token","}");return __.StrucSpec(l)}).call(this)}))}).call(this)}))},
...
*/
"union_spec":function(){var s,l;return this._or((function(){return (function(){undefined;return this._or((function(){return (function(){this._applyWithArgs("token","union");s=this._applyWithArgs("token","Id");this._applyWithArgs("token","{");l=this._many1((function(){return this._apply("struct_decl")}));this._applyWithArgs("token","}");return __.UnionSpec(l).name(s.value())}).call(this)}),(function(){return (function(){this._applyWithArgs("token","union");s=this._applyWithArgs("token","Id");return __.UnionSpec().name(s.value())}).call(this)}),(function(){return (function(){this._applyWithArgs("token","union");this._applyWithArgs("token","{");l=this._many1((function(){return this._apply("struct_decl")}));this._applyWithArgs("token","}");return __.UnionSpec(l)}).call(this)}))}).call(this)}))},

/*

    struct_decl     = spec_qual_list:s listOf(#sdeclarator, ","):l ";"      -> __.StrucDecl(s,l)
*/
"struct_decl":function(){var s,l;return this._or((function(){return (function(){undefined;return (function(){s=this._apply("spec_qual_list");l=this._applyWithArgs("listOf","sdeclarator",",");this._applyWithArgs("token",";");return __.StrucDecl(s,l)}).call(this)}).call(this)}))},

/*

    spec_qual_list  = (type_spec | type_qualifier)+:l                   -> __.SpecQList(l)
*/
"spec_qual_list":function(){var l;return this._or((function(){return (function(){undefined;return (function(){l=this._many1((function(){return this._or((function(){return (function(){return this._apply("type_spec")}).call(this)}),(function(){return (function(){return this._apply("type_qualifier")}).call(this)}))}));return __.SpecQList(l)}).call(this)}).call(this)}))},
...
*/
"sdeclarator":function(){var d,e;return this._or((function(){return (function(){undefined;return this._or((function(){return (function(){d=this._apply("declarator");this._applyWithArgs("token",":");e=this._apply("const_expr");return __.SDeclarator(d,e)}).call(this)}),(function(){return (function(){d=this._apply("declarator");return __.SDeclarator(d)}).call(this)}),(function(){return (function(){this._applyWithArgs("token",":");e=this._apply("const_expr");return __.SDeclarator(e)}).call(this)}))}).call(this)}))},
...
*/
"enum_spec":function(){var s,e;return this._or((function(){return (function(){undefined;return this._or((function(){return (function(){this._applyWithArgs("token","enum");s=this._applyWithArgs("token","Id");this._applyWithArgs("token","{");e=this._applyWithArgs("listOf","enumerator",",");this._applyWithArgs("token","}");return __.EnumDeclaration(e).name(s.value())}).call(this)}),(function(){return (function(){this._applyWithArgs("token","enum");s=this._applyWithArgs("token","Id");return __.EnumDeclaration().name(s.value())}).call(this)}),(function(){return (function(){this._applyWithArgs("token","enum");this._applyWithArgs("token","{");e=this._applyWithArgs("listOf","enumerator",",");this._applyWithArgs("token","}");return __.EnumDeclaration(e)}).call(this)}))}).call(this)}))},
...
*/
"enumerator":function(){var s,e;return this._or((function(){return (function(){undefined;return this._or((function(){return (function(){s=this._applyWithArgs("token","Id");this._applyWithArgs("token","=");e=this._apply("const_expr");return __.Enumerator(e).name(s.value())}).call(this)}),(function(){return (function(){s=this._applyWithArgs("token","Id");return __.Enumerator().name(s.value())}).call(this)}))}).call(this)}))},
...
*/
"type_qualifier":function(){var e;return this._or((function(){return (function(){undefined;return (function(){e=this._or((function(){return (function(){return this._applyWithArgs("token","const")}).call(this)}),(function(){return (function(){return this._applyWithArgs("token","volatile")}).call(this)}));return __.TypeQual().type(e.value())}).call(this)}).call(this)}))},
...
/*
    ...
    declarator      = pointer:p dir_declarator:d                    -> { d.set(p); d }
                    | dir_declarator
*/
"declarator":function(){var p,d;return this._or((function(){return (function(){undefined;return this._or((function(){return (function(){p=this._apply("pointer");d=this._apply("dir_declarator");return (function (){d.set(p);return d}).call(this)}).call(this)}),(function(){return (function(){return this._apply("dir_declarator")}).call(this)}))}).call(this)}))},
...
/*
    ...
    initializer     = "{" listOf(#initializer, ","):p ","? "}"       -> __.GroupInitializer((p.length > 1? __.SequenceExpr(p) : p[0]))
                    | assign_expr
*/
"initializer":function(){var p;return this._or((function(){return (function(){undefined;return this._or((function(){return (function(){this._applyWithArgs("token","{");p=this._applyWithArgs("listOf","initializer",",");this._opt((function(){return this._applyWithArgs("token",",")}));this._applyWithArgs("token","}");return __.GroupInitializer(((p["length"] > (1))?__.SequenceExpr(p):p[(0)]))}).call(this)}),(function(){return (function(){return this._apply("assign_expr")}).call(this)}))}).call(this)}))},
...
*/
"topLevel":function(){var u;return this._or((function(){return (function(){undefined;return (function(){u=this._apply("translation_u");this._apply("spaces");this._apply("end");return u}).call(this)}).call(this)}))}});(CParser["position_info"]=(function (input,from,to){var position=(function (pos){{var line=(1);var column=undefined};for(var i=pos;(i >= (0));i--){if((input[i] === "\n")){if(((typeof column) == "undefined")){(column=(pos - i))}else{undefined};line++}else{undefined}};if((line === (1))){(column=pos)}else{undefined};return ({"line": line,"column": column})});return ({"source": input.slice(from,to),"start": position(from),"end": position(to)})}));(CParser["spec"]=({"keywords": ["auto","break","case","char","const","continue","default","do","double","else","enum","extern","float","for","goto","if","int","long","register","return","short","signed","sizeof","static","struct","switch","typedef","union","unsigned","void","volatile","while"],"addKeywords": (function (l){if(Array.isArray(l)){(this["keywords"]=this["keywords"].concat(l))}else{undefined}}),"isKeyword": (function (k){return (this["keywords"].indexOf(k) != (- (1)))}),"typenames": [],"addTypenames": (function (l){if(Array.isArray(l)){(this["typenames"]=this["typenames"].concat(l))}else{undefined}}),"isTypename": (function (k){return (this["typenames"].indexOf(k) != (- (1)))})}));(CParser["parse"]=(function (input){return CParser.matchAll(input,"topLevel")}));(module["exports"]=CParser)}