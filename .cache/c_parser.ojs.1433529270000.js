...
/*
    ...
    enum_spec       = "enum" "Id":s                                 -> __.EnumDeclaration().name(s.value())
                    | "enum" "Id":s "{" listOf(#enumerator, ","):e "}"  -> __.EnumDeclaration(e).name(s.value())
...
/*
    ...
    enumerator      = "Id":s                                        -> __.Enumerator().name(s.value())
                    | "Id":s const_expr:e                           -> __.Enumerator(e).name(s.value())
*/
"enumerator":function(){var s,e;return this._or((function(){return (function(){undefined;return this._or((function(){return (function(){s=this._applyWithArgs("token","Id");return __.Enumerator().name(s.value())}).call(this)}),(function(){return (function(){s=this._applyWithArgs("token","Id");e=this._apply("const_expr");return __.Enumerator(e).name(s.value())}).call(this)}))}).call(this)}))},
